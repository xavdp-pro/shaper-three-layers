...
| Team credit and testing campaign history | [SHAPER-OS-V1.14 `AUTHORS.md`](https://github.com/xavdp-pro/SHAPER-OS-V1.14/blob/main/AUTHORS.md) | Commit history and trailers in the kit repository (not duplicated here) |
